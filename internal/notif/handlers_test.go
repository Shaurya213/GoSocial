...
// 		mockNotifications := []*dbmysql.Notification{}
// 		mockService.On("GetUserNotifications", mock.Anything, uint64(123), 20, 0).Return(mockNotifications, nil)
...
// 		// mockService.On("MarkAsRead", mock.Anything, "123", "123").Return(nil)
