...
// Mock Device Repository for observer testing - FIXED signatures
type MockDeviceRepositoryForObserver struct {
	mock.Mock
}

func (m *MockDeviceRepositoryForObserver) CreateOrUpdate(ctx context.Context, userID uint64, deviceToken, platform string) error {
	args := m.Called(ctx, userID, deviceToken, platform)
	return args.Error(0)
}

func (m *MockDeviceRepositoryForObserver) ActiveByUserID(ctx context.Context, userID uint64) ([]interface{}, error) {
	args := m.Called(ctx, userID)
	return args.Get(0).([]interface{}), args.Error(1)
}

func (m *MockDeviceRepositoryForObserver) GetUserDevices(ctx context.Context, userID uint64) ([]*dbmysql.Device, error) {
	args := m.Called(ctx, userID)
	return args.Get(0).([]*dbmysql.Device), args.Error(1)
}

func (m *MockDeviceRepositoryForObserver) RegisterDevice(ctx context.Context, device *dbmysql.Device) error {
	args := m.Called(ctx, device)
	return args.Error(0)
}

func (m *MockDeviceRepositoryForObserver) UpdatedDeviceActivity(ctx context.Context, deviceToken string) error {
	args := m.Called(ctx, deviceToken)
	return args.Error(0)
}

func (m *MockDeviceRepositoryForObserver) RemovedDevice(ctx context.Context, deviceToken string) error {
	args := m.Called(ctx, deviceToken)
	return args.Error(0)
}
...
// Mock Notification Repository - FIXED signatures
type MockNotificationRepositoryForObserver struct {
	mock.Mock
}
...
func (m *MockNotificationRepositoryForObserver) ByID(ctx context.Context, id uint) (interface{}, error) {
	args := m.Called(ctx, id)
	return args.Get(0), args.Error(1)
}

func (m *MockNotificationRepositoryForObserver) ByUserID(ctx context.Context, userID uint, limit, offset int) ([]interface{}, error) {
	args := m.Called(ctx, userID, limit, offset)
	return args.Get(0).([]interface{}), args.Error(1)
}
...
func (m *MockNotificationRepositoryForObserver) UpdateStatus(ctx context.Context, id uint, status string) error {
	args := m.Called(ctx, id, status)
	return args.Error(0)
}

func (m *MockNotificationRepositoryForObserver) MarkAsRead(ctx context.Context, notificationID uint, userID uint) error {
	args := m.Called(ctx, notificationID, userID)
	return args.Error(0)
}

func (m *MockNotificationRepositoryForObserver) Delete(ctx context.Context, id uint) error {
	args := m.Called(ctx, id)
	return args.Error(0)
}

func (m *MockNotificationRepositoryForObserver) UnreadCount(ctx context.Context, userID uint) (int64, error) {
	args := m.Called(ctx, userID)
	return args.Get(0).(int64), args.Error(1)
}
...
func TestFCMObserver_Update_ScheduledNotification(t *testing.T) {
	...
	event := common.NotificationEvent{
		Type:        "test",
		UserID:      1, // FIXED: uint instead of string
		Header:      "Test",
		Content:     "Test content",
		Priority:    3,
		ScheduledAt: &futureTime,
...
func TestFCMObserver_Update_NoActiveDevices(t *testing.T) {
	...
	// FIXED: uint64(1) to match ActiveByUserID signature
	mockDeviceRepo.On("ActiveByUserID", mock.Anything, uint64(1)).Return([]interface{}{}, nil)
	err := observer.Update(event)
	assert.NoError(t, err)
	mockDeviceRepo.AssertExpectations(t)
}
...
func TestFCMObserver_Update_DeviceRepoError(t *testing.T) {
	...
	// FIXED: uint64(1) to match signature
	mockDeviceRepo.On("ActiveByUserID", mock.Anything, uint64(1)).Return([]interface{}{}, errors.New("db error"))
	err := observer.Update(event)
	assert.Error(t, err)
	assert.Contains(t, err.Error(), "failed to get devices")
	mockDeviceRepo.AssertExpectations(t)
...
func TestFCMObserver_Update_InvalidDeviceType(t *testing.T) {
	...
	// FIXED: uint64(1) to match signature
	mockDeviceRepo.On("ActiveByUserID", mock.Anything, uint64(1)).Return(devices, nil)
	err := observer.Update(event)
	assert.NoError(t, err)
	mockDeviceRepo.AssertExpectations(t)
}
...
func BenchmarkEmailObserver_Update(b *testing.B) {
	mockEmailService := &MockEmailServiceForObserver{}
	observer := NewEmailObserver(mockEmailService)
	event := common.NotificationEvent{
		Type:     "benchmark",
	...
	mockEmailService.On("SendEmail", mock.Anything, mock.Anything, mock.Anything).Return(nil)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		observer.Update(event)
	}
...
func BenchmarkDatabaseObserver_Update(b *testing.B) {
	mockRepo := &MockNotificationRepositoryForObserver{}
	observer := NewDatabaseObserver(mockRepo)
	event := common.NotificationEvent{
		Type:     "benchmark",
