...
type GRPCHandler struct {
	pb.UnimplementedNotificationServiceServer
	service    NotificationServiceInterface // FIXED: Use interface instead of concrete type
	config     *config.Config
	fcmClient  *messaging.Client
	deviceRepo common.DeviceRepository
}

// FIXED: Update constructor to accept interface
func NewNotificationHandler(
...
// FIXED: Update GRPC handler constructor to accept interface
func NewGRPCHandler(
	service NotificationServiceInterface, // Changed to interface
	config *config.Config,
	fcmClient *messaging.Client,
